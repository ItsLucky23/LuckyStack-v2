...
import * as api6 from '../../src/test/_api/updateAdmin_v1';
import * as api7 from '../../src/test/test2/_api/updateUser_v1';
...
export const apis: Record<string, { auth: any, main: any, rateLimit?: number | false, httpMethod?: 'GET' | 'POST' | 'PUT' | 'DELETE', inputType?: string, inputTypeFilePath?: string }> = {
  ...
  "api/examples/adminOnly/v1": {
    ...
    inputType: "{ }",
    inputTypeFilePath: "src/examples/_api/adminOnly_v1.ts",
  },
  "api/examples/publicApi/v1": {
    ...
    inputType: "{\n  message: string\n}",
    inputTypeFilePath: "src/examples/_api/publicApi_v1.ts",
  },
  "api/examples/toggleAdmin/v1": {
    ...
    inputType: "{ }",
    inputTypeFilePath: "src/examples/_api/toggleAdmin_v1.ts",
  },
  ...
  "api/test/updateAdmin/v1": {
    auth: "auth" in api6 ? api6.auth : {},
    main: api6.main,
    rateLimit: "rateLimit" in api6 ? (api6.rateLimit as number | false | undefined) : undefined,
    httpMethod: "httpMethod" in api6 ? (api6.httpMethod as 'GET' | 'POST' | 'PUT' | 'DELETE' | undefined) : undefined,
    inputType: "{\n  id: number;\n  name: string\n}",
    inputTypeFilePath: "src/test/_api/updateAdmin_v1.ts",
  },
  "api/test/test2/updateUser/v1": {
    auth: "auth" in api7 ? api7.auth : {},
    main: api7.main,
    rateLimit: "rateLimit" in api7 ? (api7.rateLimit as number | false | undefined) : undefined,
    httpMethod: "httpMethod" in api7 ? (api7.httpMethod as 'GET' | 'POST' | 'PUT' | 'DELETE' | undefined) : undefined,
    inputType: "{\n  role: 'admin';\n  id: number;\n  name: string\n}",
    inputTypeFilePath: "src/test/test2/_api/updateUser_v1.ts",
  },
};
...
export const syncs: Record<string, { main: any, auth: Record<string, any>, inputType?: string, inputTypeFilePath?: string }> | any = {
  ...
  "sync/examples/updateCounter/v1_server": { auth: "auth" in syncServer1 ? syncServer1.auth : {}, main: syncServer1.main, inputType: "{\n  increase: boolean\n}", inputTypeFilePath: "src/examples/_sync/updateCounter_server_v1.ts" },
};
