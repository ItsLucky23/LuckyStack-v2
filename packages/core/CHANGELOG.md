...
- Routed HTTP API invocation now fails closed with `api.methodMapUnavailable` when the generated method map has not been registered or does not contain the route; socket-mode compatibility inference remains unchanged.
