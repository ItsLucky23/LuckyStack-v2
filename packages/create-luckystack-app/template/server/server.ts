...
(async () => {
  ...
  //? without you having to maintain `server/prod/runtimeMaps.ts`. The
  //? `LUCKYSTACK_BUNDLE` env var selects the preset (defaults to `default`).
  //? Generated by `scripts/generateServerRequests.ts` at build time.
