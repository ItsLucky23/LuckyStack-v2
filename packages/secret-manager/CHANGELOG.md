...
- Updated extension guidance to route resolution failures through registered error trackers rather than naming a single vendor.

## [0.8.1] - 2026-07-27

### Fixed

- Dev secret-reload watchers and polling follow `NODE_ENV` and stay disabled in named production topology environments.
