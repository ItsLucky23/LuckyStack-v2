...
# 0019 — One unmocked runtime import made a load-dependent failure surface in a different test
...
Related: `docs/lessons/0018-a-skipped-check-reports-the-same-value-as-a-clean-one.md` — the same family
