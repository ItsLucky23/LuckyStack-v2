...
# 0018 — A generator that skips itself reports the same value as one that found nothing
...
Related: `docs/decisions/0046-graph-is-repo-scoped-with-derived-closures.md`.
