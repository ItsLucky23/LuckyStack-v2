...
## Artifact sizes (total ≈ 73,317 tokens if all loaded)

| Artifact | Est. tokens | Bytes | Purpose |
| --- | --- | --- | --- |
| `contract` — `CLAUDE.md` | 10,230 | 40,921 | Always-on rules (read every session). |
| `quick-index` — `docs/AI_QUICK_INDEX.md` | 31,994 | 127,977 | Framework surfaces + package map. |
...
- **Load** (≈ 19,413 tokens): `contract`, `decisions`, `project-index`
