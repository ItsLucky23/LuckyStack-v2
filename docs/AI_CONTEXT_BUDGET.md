...
## Artifact sizes (total ≈ 84,571 tokens if all loaded)
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 10,794 | 43,174 | Why-it-is-this-way (ADRs). |
...
- **Load** (≈ 25,056 tokens): `contract`, `decisions`, `project-index`
