...
## Artifact sizes (total ≈ 80,470 tokens if all loaded)
...
| `lessons` — `docs/AI_LESSONS_INDEX.md` | 3,283 | 13,132 | Known pitfalls (what failed). |
...
- **Load** (≈ 14,862 tokens): `contract`, `lessons`
