...
## Artifact sizes (total ≈ 86,786 tokens if all loaded)

| Artifact | Est. tokens | Bytes | Purpose |
| --- | --- | --- | --- |
| `contract` — `CLAUDE.md` | 11,580 | 46,320 | Always-on rules (read every session). |
| `quick-index` — `docs/AI_QUICK_INDEX.md` | 34,496 | 137,982 | Framework surfaces + package map. |
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 11,921 | 47,685 | Why-it-is-this-way (ADRs). |
| `lessons` — `docs/AI_LESSONS_INDEX.md` | 5,115 | 20,458 | Known pitfalls (what failed). |
...
- **Load** (≈ 26,184 tokens): `contract`, `decisions`, `project-index`
...
- **Load** (≈ 16,695 tokens): `contract`, `lessons`
