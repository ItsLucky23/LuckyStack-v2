...
## Artifact sizes (total ≈ 83,678 tokens if all loaded)

| Artifact | Est. tokens | Bytes | Purpose |
| --- | --- | --- | --- |
| `contract` — `CLAUDE.md` | 11,579 | 46,314 | Always-on rules (read every session). |
| `quick-index` — `docs/AI_QUICK_INDEX.md` | 34,027 | 136,107 | Framework surfaces + package map. |
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 10,393 | 41,573 | Why-it-is-this-way (ADRs). |
...
- **Load** (≈ 24,655 tokens): `contract`, `decisions`, `project-index`
