...
## Artifact sizes (total ≈ 68,210 tokens if all loaded)
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 4,548 | 18,190 | Why-it-is-this-way (ADRs). |
...
- **Load** (≈ 17,407 tokens): `contract`, `decisions`, `project-index`
