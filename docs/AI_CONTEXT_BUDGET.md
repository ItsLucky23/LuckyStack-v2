...
## Artifact sizes (total ≈ 76,355 tokens if all loaded)
...
| `lessons` — `docs/AI_LESSONS_INDEX.md` | 1,801 | 7,202 | Known pitfalls (what failed). |
...
- **Load** (≈ 12,591 tokens): `contract`, `lessons`
