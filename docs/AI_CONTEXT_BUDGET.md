...
## Artifact sizes (total ≈ 81,683 tokens if all loaded)

| Artifact | Est. tokens | Bytes | Purpose |
| --- | --- | --- | --- |
| `contract` — `CLAUDE.md` | 11,579 | 46,314 | Always-on rules (read every session). |
| `quick-index` — `docs/AI_QUICK_INDEX.md` | 33,501 | 134,002 | Framework surfaces + package map. |
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 8,924 | 35,696 | Why-it-is-this-way (ADRs). |
...
- **Load** (≈ 23,186 tokens): `contract`, `decisions`, `project-index`
