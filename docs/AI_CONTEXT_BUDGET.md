...
## Artifact sizes (total ≈ 88,353 tokens if all loaded)

| Artifact | Est. tokens | Bytes | Purpose |
| --- | --- | --- | --- |
| `contract` — `CLAUDE.md` | 11,580 | 46,320 | Always-on rules (read every session). |
| `quick-index` — `docs/AI_QUICK_INDEX.md` | 35,114 | 140,457 | Framework surfaces + package map. |
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 12,258 | 49,031 | Why-it-is-this-way (ADRs). |
...
- **Load** (≈ 26,521 tokens): `contract`, `decisions`, `project-index`
