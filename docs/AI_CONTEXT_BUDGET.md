...
## Artifact sizes (total ≈ 85,408 tokens if all loaded)

| Artifact | Est. tokens | Bytes | Purpose |
| --- | --- | --- | --- |
| `contract` — `CLAUDE.md` | 11,579 | 46,314 | Always-on rules (read every session). |
| `quick-index` — `docs/AI_QUICK_INDEX.md` | 34,292 | 137,166 | Framework surfaces + package map. |
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 11,288 | 45,151 | Why-it-is-this-way (ADRs). |
...
- **Load** (≈ 25,550 tokens): `contract`, `decisions`, `project-index`
