...
## Artifact sizes (total ≈ 84,082 tokens if all loaded)
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 10,639 | 42,557 | Why-it-is-this-way (ADRs). |
...
- **Load** (≈ 24,901 tokens): `contract`, `decisions`, `project-index`
...
- **Load** (≈ 15,624 tokens): `contract`, `lessons`
