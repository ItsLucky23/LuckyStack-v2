...
## Artifact sizes (total ≈ 75,824 tokens if all loaded)
...
| `lessons` — `docs/AI_LESSONS_INDEX.md` | 1,548 | 6,191 | Known pitfalls (what failed). |
...
- **Load** (≈ 12,241 tokens): `contract`, `lessons`
