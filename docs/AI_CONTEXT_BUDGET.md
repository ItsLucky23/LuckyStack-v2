...
## Artifact sizes (total ≈ 87,007 tokens if all loaded)
...
| `lessons` — `docs/AI_LESSONS_INDEX.md` | 5,335 | 21,341 | Known pitfalls (what failed). |
...
- **Load** (≈ 16,915 tokens): `contract`, `lessons`
