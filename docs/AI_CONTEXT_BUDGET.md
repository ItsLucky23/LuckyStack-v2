...
## Artifact sizes (total ≈ 70,284 tokens if all loaded)
...
| `decisions` — `docs/AI_DECISIONS_INDEX.md` | 6,122 | 24,487 | Why-it-is-this-way (ADRs). |
...
- **Load** (≈ 19,035 tokens): `contract`, `decisions`, `project-index`
