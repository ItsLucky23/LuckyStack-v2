...
That is the failure mode [[0055]] exists to prevent, shipped by construction: a second, authoritative-looking
...
After [[0053]] there is a second, harder reason: the generated artifacts are gitignored, so on a clean CI
