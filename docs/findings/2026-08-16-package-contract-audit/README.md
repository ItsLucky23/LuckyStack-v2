...
| PKG-04 | Sentry-specific package docs remain intentionally Sentry-specific, but generic error-flow statements outside that dedicated integration surface need a separate wording pass to consistently say “registered error tracker(s)”. | LOW | open | 2026-08-16 | — | Not changed in this pass because the dedicated Sentry compatibility surface is real and historical wording must be separated carefully from generic flow docs. |
