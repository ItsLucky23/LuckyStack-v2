...
| fix/prod-function-map-divergence | (none) | 2026-08-21 | active — function-injection discovery geconsolideerd in één registry (ADR 0046); dev/prod-divergentie op `functions.*` gedicht, nog niet gepubliceerd. | 2 |
