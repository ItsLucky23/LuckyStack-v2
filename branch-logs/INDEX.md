...
| main | (none) | 2026-07-13 12:15 | active — v0.6.1 GEPUBLICEERD naar npm (17 pkgs; mikro-orm scaffold-fix + 7 devkit/core consumer-fixes + `luckystack update --app` [ADR 0025] + AI-upgrade-runbook). NIET gepusht naar origin (SSH-auth ontbreekt in deze omgeving — user pusht zelf: `git push origin main && git push origin v0.6.1`) | 28 |
