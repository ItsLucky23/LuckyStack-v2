...
| main | (none) | 2026-07-13 23:30 | active — v0.6.4 GEPUBLICEERD + gepusht (17 pkgs): FIX-1 Redis secret-pointer boot ECHT gefixt via eager rebuild+register (0.6.3-reset was onvoldoende) [ADR 0026, lesson 0006]. Voorheen: v0.6.3 (reset-poging + ai:lint-FP + ES2023 + logger-timestamps), v0.6.2 (cron wizard-opt-in), v0.6.1 (`update --app` [ADR 0025]) | 33 |
