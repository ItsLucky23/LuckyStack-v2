...
| main | (none) | 2026-07-14 08:35 | active — v0.6.5 GEPUBLICEERD + gepusht (17 pkgs): FIX-1 Redis secret-pointer boot — de 0.6.4-rebuild werd NOOIT getriggerd (gate falsy: scaffold registreert secretManager niet in projectConfig); secret-manager firet nu zelf de channel na resolve [ADR 0026, lesson 0007]. Voorheen: v0.6.4 (rebuild-logica), v0.6.3 (reset + ai:lint-FP + ES2023 + timestamps), v0.6.2 (cron wizard) | 34 |
