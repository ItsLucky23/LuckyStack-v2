...
| main | (none) | 2026-08-29 17:15 | active — **v0.9.0 gepubliceerd** via GitHub Actions met SLSA-provenance; 17/17 packages op npm geverifieerd, CI op main groen. AI-context-artifacts zijn nu een gitignored cache met één `ai:refresh`, hook draait alleen checks, `ai:check-ids` blokkeert dubbele record-nummers. Twee stille cross-platform bugs gevangen die alleen de pipeline kon zien: `npx create-luckystack-app` deed niets op macOS/Linux (lesson 0021) en de frontmatter-parser was blind voor CRLF (lesson 0022). | 83 |
