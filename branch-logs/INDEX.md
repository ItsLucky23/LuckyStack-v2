...
| debug/devtools-lag | (none) | 2026-07-03 | active (prod-bundel gefixt via overlay-bundling + registerOverlayLoader; client:port-script; Playwright-verificatie prod+dev groen; handmatige DevTools-eindcheck blijft open) | 5 |
