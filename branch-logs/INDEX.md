...
| feat/orm-aware-cli | (none) | 2026-07-11 15:40 | active (CLI overal ORM-bewust + BIDIRECTIONELE ORM-switch als manage-stap 0: switchOrm.ts fresh-render-based, planOrm eerst zodat auth op de nieuwe laag landt, config.ts User-type beide kanten op, parity-guards tegen scaffolder-exports, echte-npx smoke groen; rest: settings-routes porten naar UserAdapter) | 2 |
