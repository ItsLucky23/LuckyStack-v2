...
| main | (none) | 2026-07-13 13:30 | active — v0.6.1 gepubliceerd + gepusht (17 pkgs; mikro-fix + 7 devkit/core-fixes + `update --app` [ADR 0025] + AI-upgrade-runbook). Daarna: `@luckystack/cron` als wizard-opt-in (`--cron`, dependency-only, byte-parity met `add cron`) — 0.6.2-kandidaat, nog niet gepubliceerd | 29 |
