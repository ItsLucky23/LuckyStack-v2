...
|---|---|---|---|---|
| feat/email-code-2fa | (none) | 2026-07-12 12:30 | active (backend + LoginForm-statemachine + template-laag compleet: passwordless email-code login + 2FA TOTP/email-fallback/recovery [ADR 0024 t.b.d.]; fase 2b: settings-2FA-UI, wizard/manage, docs, e2e) | 2 |
