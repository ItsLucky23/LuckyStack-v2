...
| debug/devtools-lag | (none) | 2026-07-03 | active — onderzoek AFGEROND (echte-DevTools-meting: fix herstelt vrijwel hele lag, +25% fps; restlag = normale overhead + tijdelijke source-map-parse; prod-bundel + client:port meegefixt) | 6 |
