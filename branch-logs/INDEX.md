...
| main | (none) | 2026-07-14 12:20 | active — v0.6.6 GEPUBLICEERD + gepusht (17 pkgs): opgeruimd — vestigiale server-boot-gate + ProjectConfig.secretManager weg; secrets-resolved-channel is de enige trigger [ADR 0026]. Voorheen: v0.6.5 (secret-manager firet de channel — de echte fix), v0.6.4 (rebuild-logica), v0.6.3 (reset-poging), v0.6.2 (cron wizard) | 35 |
