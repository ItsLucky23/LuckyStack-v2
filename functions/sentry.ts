...
//? `packages/error-tracking/src/autoInstrumentation.ts`). Editing this shim does
//? NOT change the framework's automatic `setSentryUser` / `startSpan` wiring on
//? the API + sync hot paths.
//?
